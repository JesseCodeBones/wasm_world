...
class InstructionOPCodePrinter {
private:
  std::unordered_map<uint8_t, std::string> wasmOpcodeMap = {
      ...
      {0x06, /* try */ "TRY"},
      {0x07, /* catch* */ "CATCH"},
      {0x08, /* throw of a try catch */ "THROW"},
      {0x09, /* rethrow of a try catch */ "RETHROW"},
      {0x0a, "UNUSED_0x0a"},
      {0x0b, /* end */ "END"},
      {0x0c, /* br */ "BR"},
      {0x0d, /* br if */ "BR_IF"},
      {0x0e, /* br table */ "BR_TABLE"},
      {0x0f, /* return */ "RETURN"},
      {0x10, /* call */ "CALL"},
      {0x11, /* call_indirect */ "CALL_INDIRECT"},
      {0x12, /* return_call */ "RETURN_CALL"},
      {0x13, /* return_call_indirect */ "RETURN_CALL_INDIRECT"},
      {0x14, /* call_ref */ "CALL_REF"},
      {0x15, /* return_call_ref */ "RETURN_CALL_REF"},
      {0x1a, "DROP"},
      {0x1b, "SELECT"},
      {0x1c, "SELECTTYPE"},
      {0x20, "LOCALGET"},
      ...
      {0x23, "GLOBALGET"},
      {0x24, "GLOBALSET"},
      {0x28, /* i32.load */ "I32_LOAD"},
      {0x29, /* i64.load */ "I64_LOAD"},
      {0x2a, /* f32.load */ "F32_LOAD"},
      {0x2b, /* f64.load */ "F64_LOAD"},
      {0x2c, /* i32.load8_s */ "I32_LOAD8_S"},
      {0x2d, /* i32.load8_u */ "I32_LOAD8_U"},
      {0x2e, /* i32.load16_s */ "I32_LOAD16_S"},
      {0x2f, /* i32.load16_u */ "I32_LOAD16_U"},
      {0x30, /* i64.load8_s */ "I64_LOAD8_S"},
      {0x31, /* i64.load8_u */ "I64_LOAD8_U"},
      {0x32, /* i64.load16_s */ "I64_LOAD16_S"},
      {0x33, /* i64.load16_u */ "I64_LOAD16_U"},
      {0x34, /* i32.load32_s */ "I64_LOAD32_S"},
      {0x35, /* i32.load32_u */ "I64_LOAD32_U"},
      {0x36, /* i32.store */ "I32_STORE"},
      {0x37, /* i64.store */ "I64_STORE"},
      {0x38, /* f32.store */ "F32_STORE"},
      {0x39, /* f64.store */ "F64_STORE"},
      {0x3a, /* i32.store8 */ "I32_STORE8"},
      {0x3b, /* i32.store16 */ "I32_STORE16"},
      {0x3c, /* i64.store8 */ "I64_STORE8"},
      {0x3d, /* i64.store16 */ "I64_STORE16"},
      ...
      {0xc0, /* i32.extend8_s */ "I32EXTEND8_S"},
      {0xc1, /* i32.extend16_s */ "I32EXTEND16_S"},
      {0xc2, /* i64.extend8_s */ "I64EXTEND8_S"},
      {0xc3, /* i64.extend16_s */ "I64EXTEND16_S"},
      {0xc4, /* i64.extend32_s */ "I64EXTEND32_S"}};

public:
  std::string getOPCodeName(uint8_t opCode) {
    return wasmOpcodeMap[opCode];
  }
};
